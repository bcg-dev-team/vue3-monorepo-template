  ...
  <div class="flex flex-col items-center gap-1">
    ...
    <div class="flex h-6 w-full gap-1">
      ...
      <div class="flex w-full items-center justify-between text-xs">
        <div class="relative">
          <div class="relative z-10 ml-[9px]">1.16790</div>
          <div
    ...
    <div class="flex h-6 w-full gap-1">
      <div class="flex h-6 w-full items-center justify-between text-xs">
        <div class="relative z-10">5.00</div>
        <div class="relative">
          <div class="relative z-10 mr-[9px]">1.35064</div>
          <div
      ...
      <div class="flex w-full items-center justify-between text-xs">
        <div class="relative">
          <div class="relative z-10 ml-[9px]">1.35076</div>
          <div
    ...
    <div class="flex h-6 w-full gap-1">
      <div class="flex h-6 w-full items-center justify-between text-xs">
        <div class="relative z-10">10.00</div>
        <div class="relative">
          <div class="relative z-10 mr-[9px]">1.35064</div>
          <div
      ...
      <div class="flex w-full items-center justify-between text-xs">
        <div class="relative">
          <div class="relative z-10 ml-[9px]">1.35090</div>
          <div
    ...
    <div class="flex h-6 w-full gap-1">
      <div class="flex h-6 w-full items-center justify-between text-xs">
        <div class="relative z-10">30.00</div>
        <div class="relative">
          <div class="relative z-10 mr-[9px]">1.35071</div>
          <div
      ...
      <div class="flex w-full items-center justify-between text-xs">
        <div class="relative">
          <div class="relative z-10 ml-[9px]">1.35096</div>
          <div
    ...
    <div class="flex h-6 w-full gap-1">
      <div class="flex h-6 w-full items-center justify-between text-xs">
        <div class="relative z-10">50.00</div>
        <div class="relative">
          <div class="relative z-10 mr-[9px]">1.35078</div>
          <div
